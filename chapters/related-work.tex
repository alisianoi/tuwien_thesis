...
The Catena-Butterfly(-Full) and Catena-Dragonfly(-Full) are the most notable configurations of Catena. The former one is recommended when the memory-hard property is required. The -Full versions utilize the complete set of rounds of the underlying hash function BLAKE2b by Aumasson et al. \cite{aumasson:2013:blake2}.
