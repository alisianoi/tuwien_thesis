...
One of the first steps is to determine the minimum versions of Android devices and API levels necessary. Since lyra2-java makes use of unsigned long number arithmetic, Java 1.8 support is required. This translates into a minimum Android versions of 7.0 and an API level of 24 \footnote{https://developer.android.com/guide/platform/j8-jack.html}.

The most common development environment for Android applications is the Android Studio. Support for Java 1.8 features has not yet landed into the release version of this IDE. So, in order to be able to develop a mobile application with Lyra2 a development version \texttt{3.0} needs to be installed.
