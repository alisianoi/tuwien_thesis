...
\end{minted}
\normalsize
\caption{Blake2b as instance of the Sponge class, demonstrating optimised rotations on lines 5, 8 and 11. Line 16 performs the complete set of rotations (no optimisation).}
...
\end{minted}
\normalsize
\caption{BlaMka as instance of the Sponge class, the same rotation trick in action on lines 16, 19 and 22. Line 27 performs the complete set of rotations (no optimisation).}
